...
## search-commands
Allows in-player searching of commands. Shows the command name and the raw argument list, as returned by the Lua API. Requires abuild of mpv with console.lua for dynamic input.
